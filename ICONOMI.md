# ICONOMI
ICONOMI is a platform that deals in digital assets to enable anyone to easily invest in a variety of cryptocurrency funds, or create and manage their own. These funds are called *Digital Portfolios*.

Without using a service such as ICONOMI, creating a cryptocurrency portfolio made up of several assets can be time-consuming, technically difficult and risky, opening up even savvy users to hacks and other pitfalls unique to the blockchain environment. Using ICONOMI, users can choose to invest in a growing number of existing Digital Portfolios. In doing so, this removes the need for the user to design and rebalance a portfolio, store assets securely and register with multiple exchanges. A list of Digital Portfolios offered on the ICONOMI platform are available [here.](https://my.iconomi.com/?filter=digital-portfolios)
